...
# make sure the currently used power (in Watt) is provided as input variable
if [[ -z $1 ]]; then
...
# do until we get a valid value, i is counter and when >5 exit (inverter goes off during the night)
i=0
